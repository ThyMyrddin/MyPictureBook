...
<pre>       </pre>
      <a class="buy-tickets scrollto" href="../Login_form/addalbum.php">ADD ALBUM</a>
      <a class="buy-tickets scrollto" href="delalbum.php">DELETE ALBUM</a>
    </div>
  </header><!-- End Header -->
  ...
  <section id="about"></section>
    ...
    <section id="gallery">
      ...
      <div class="gallery-slider swiper">
        ...
        <form action="album.php" methode="GET">
